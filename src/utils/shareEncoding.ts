...
export const LEGACY_FULL_PROJECT_SHARE_FORMAT_VERSION = 5
export const LEGACY_FULL_PROJECT_SHARE_FULLSCREEN_INTENT_FORMAT_VERSION = 6
export const SHARE_FORMAT_VERSION = 7
export const SHARE_FULLSCREEN_INTENT_FORMAT_VERSION = 8
