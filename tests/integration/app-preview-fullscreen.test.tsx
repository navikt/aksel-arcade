...
const shellCases: Array<{ label: string; shellCapabilities: ShellCapabilities }> = [
  { label: 'Web Arcade', shellCapabilities: WEB_ARCADE_CAPABILITIES },
  { label: 'Desktop Arcade', shellCapabilities: DESKTOP_ARCADE_CAPABILITIES },
]
...
describe('App preview fullscreen layout', () => {
  ...
  it.each(shellCases)(
    'hides the normal Arcade header and editor in $label, preserves history, and saves fullscreen without touching lastModified',
    async ({ shellCapabilities }) => {
