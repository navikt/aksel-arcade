  ...
  switch (uri) {
    ...
    case 'arcade://desktop/authoring-guide':
      return [
        ...
        '  <Page.Block width="text" gutters>',
        '    <VStack gap="space-24">',
        '      <FormProgress totalSteps={stepLabels.length} activeStep={activeStep}>',
        ...
        '      </FormProgress>',
        '      <Stepper aria-label="Flow steps" activeStep={activeStep}>',
        '        <Stepper.Step href="#">Start</Stepper.Step>',
        '        <Stepper.Step href="#">Details</Stepper.Step>',
        '        <Stepper.Step href="#">Review</Stepper.Step>',
        '      </Stepper>',
        '      {activeStep === 1 ? (',
        '        <TextField',
        '          label="Title"',
